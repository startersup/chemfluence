...
$id=$_SESSION['id'];
if($_SESSION['name']=="Petroken"||$_SESSION['name']=="Response")
{
  $sql="select * from workshop where id='$id' AND event='".$_SESSION['name']."'";
  ...
  echo "<script type='text/javascript'> alert('Already Registered'); </script>";
    ...
    $dept=$row['dept'];
    $college=$row['college'];
    $sql = "INSERT into workshop (event,id,name,number,email,dept,college,payment) VALUES ('".$_SESSION['name']."','".$_SESSION['id']."','$name',$number,'$mail','$dept','$college','Onspot')";
    $res=mysqli_query($conn,$sql);
    ...
    $message .= '<html>
        ...
        <table class=" main contenttable" align="center" style="font-weight: normal;border-collapse: collapse;border: 0;margin-left: auto;margin-right: auto;padding: 0;font-family: Arial, sans-serif;color: #555559;background-color: white;font-size: 16px;line-height: 26px;width: 600px;">
          ...
          We, the organisers of Chemfluence 2k19 would like to welcome you to our Extravaganza of this academic year. This mail is in confirmation of your successful subscription and registration for the workshop. We expect to meet you soon and welcome you in person . Once again, a warm welcome from the organising committee of Chemfluence 2k19.<br><p>
                          </div>
                          </td>
                        </tr>
                        <tr>
...
else if($_SESSION['name']=="Accommodation")
  {
			    				...
			    				<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;font-family: Arial, sans-serif;">
			    								...
			    								<tr>
			    									...
			    									<div class="mktEditable" id="main_text">
			    										<p style="font-size:19px;line-height:30px;">Hello <b> '.$name.' </b>,<br><br>
			    										Greetings from Chemfluence !! <br><br>
			    We got an request for Accommodation. we hope that it was from you, We will provide you the comfortable accommodation for you. <br><p>
			    									</div>
			    									</td>
			    								</tr>
			    								<tr>

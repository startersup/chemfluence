...
<head>
    <meta charset="utf-8">
    <title>Chemfluence 2K19 | National Level Technical Symposium</title>
    <link rel="icon" href="./assets/images/logo.png" type="image" sizes="16x16">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link href="https://fonts.googleapis.com/css?family=Merriweather|Montserrat:400,700|Open+Sans|Roboto:500" rel="stylesheet">
    ...
    <section class="main">
        <div class="container top">
            <div class="row">
                <div class="col-md-10">
                    <center>
                        <img class="mainbanner" src="assets/images/chemfluence%20typo.png">
                        <p class="ptags">starts at</p>
                        <ul>
...
<center><h3>25<sup>th</sup>March  -  27<sup>th</sup> March</h3>
                        <div class="explore">
                          <a href="./events">  <button class="button button1">Explore Events</button></a>
                        </div>

        ...
        <div class="container top">
            <div class="row">
                ...
                <div class="col-md-7 card eventspace" style="background-color:#fdfdfd;" id="borderimg2">
                    <center>
                        <span> <img class="reg" src="../assets/images/bat.png"></span>
                        <h2>Welcome Back Again!</h2></center>
                        <br>
                   <center> <form class="form-inline" method="post" action=" ">
    <div class="form-group">
      <input type="text" style="width:100%;" class="controls" placeholder="Email / Phone Number" name="email" required="">
    </div>
    <div class="form-group">
      <input type="password" style="width:100%;" class="controls" placeholder="Password" name="password" required="">
    </div>
